...
| [Completions](https://modelcontextprotocol.io/specification/2025-11-25/server/utilities/completion) | ✅         | Prompt argument and resource template variable completions are forwarded from upstream servers to the connected client. Resource templates are aggregated and namespaced alongside static resources.                                                                                                                                                                    |
