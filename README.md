...
| [Elicitation](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation)          | ⚠️         | Elicitation requests (form and URL mode) are proxied from upstream servers to the connected client. No shim is ([currently](https://github.com/karashiiro/my-cool-proxy/issues/20)) available for clients that don't natively support elicitation (unlike [sampling](./docs/configuration.md#acp-agent-client-protocol) which can be shimmed via ACP).                  |
...
| OAuth 2.0                                                                                           | ❌         | OAuth 2.0 authentication challenges are not yet supported (but [will be](https://github.com/karashiiro/my-cool-proxy/issues/70))                                                                                                                                                                                                                                        |
