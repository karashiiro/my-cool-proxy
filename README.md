...
| [Prompts](https://modelcontextprotocol.io/specification/2025-11-25/server/prompts)                  | ✅         | My Cool Proxy forwards prompts from your MCP servers to the connected client and provides `_gateway.read_prompt()` and `_gateway.list_prompts()` Lua builtins for agents to load them within scripts.                                 |
